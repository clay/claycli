...
describe('prefixes', () => {
  ...
  describe('urlToUri', () => {
    ...
    it('handles schemeless domain input', () => {
      expect(lib.urlToUri('domain.com/_components/foo/instances/bar')).toBe('domain.com/_components/foo/instances/bar');
    });

    it('handles schemeless page input with extension', () => {
      expect(lib.urlToUri('domain.com/_pages/foo.html')).toBe('domain.com/_pages/foo');
    });
  });
  ...
  describe('getExt', () => {
    ...
    it('handles schemeless domain input with extension', () => {
      expect(lib.getExt('domain.com/_pages/foo.html')).toBe('.html');
    });

    it('handles schemeless domain input without extension', () => {
      expect(lib.getExt('domain.com/_components/foo')).toBe(null);
    });
  });
});
