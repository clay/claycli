...
async function generateViewInitEntry() {
  ...
  const content = `\
// AUTO-GENERATED by clay pack-next — DO NOT EDIT.
...
function getEsbuildConfig(options = {}) {
  ...
  // This lets claycli.config.js packNextConfig reference legacy files (e.g. the
  ...
  const config = {
    ...
    define: {
      ...
      // webpack-era pack-next-inject.js file in the consuming repo.
      DS: 'window.DS',
