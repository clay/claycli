...
const { EnvironmentPlugin, NormalModuleReplacementPlugin, ProgressPlugin, ProvidePlugin } = require('webpack');
...
function createConfig(argv) {
  ...
  const variableList = amphoraFs.tryRequire(path.join(process.cwd(), 'client-env.json'));
