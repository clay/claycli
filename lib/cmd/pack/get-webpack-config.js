...
const { NormalModuleReplacementPlugin, ProgressPlugin, ProvidePlugin } = require('webpack');
...
function buildGlobalConfig(config) {
  ...
  const { js: globalEntry } = getEntries('./global', 'client.pack.js');
