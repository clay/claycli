...
const { DefinePlugin, NormalModuleReplacementPlugin, ProgressPlugin, ProvidePlugin } = require('webpack');
...
function buildGlobalConfig(config) {
   ...
   */
  config.output
    .chunkFilename('public/scripts/[id].[contenthash].js')
    .crossOriginLoading('anonymous')
    .filename('public/scripts/[name].[contenthash].js')
