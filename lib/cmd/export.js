...
function builder(yargs) {
  return yargs
    ...
    .example('$0 export -c domain.com/_components/foo', 'export component to stdout')
    .example('$0 export -c domain.com/_components/foo backup.json', 'export component to json')
    .example('$0 export -p domain.com/_pages/123 page-backup', 'export page to yaml')
