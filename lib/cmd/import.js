...
function showCompleted(results) {
  ...
  if (skippedResults.length) {
    logger.info(`Skipped ${pluralize('resource', skippedResults.length, true)} because they appeared as layouts or layout children and already exist. Use --ovewriteLayouts to overwrite them.`);
  }
