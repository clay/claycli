...
function builder(yargs) {
  return yargs
    .usage('Usage: $0 import [--site, --file, --url] [site]')
    .example('$0 import -u domain.com/components/foo/instances/bar', 'import component instance to CLAY_DEFAULT_SITE')
    .example('$0 import -u domain.com/pages/foo local', 'import page "foo" to local')
