...
function buildPlugins(options, overrides) {
  ...
  const plugins = [
    ...
    commonjs({
      ...
      // Match esbuild: `const x = require('./namespace-cjs')` should be `x.fn`, not only
      // `x.default.fn`. Keeps sites free of `module.exports.default = module.exports` shims.
...
async function buildJS(options = {}) {
  ...
  if (entryPoints.length === 0) {
    throw new Error(
      'clay rollup: no entry points found.\n' +
