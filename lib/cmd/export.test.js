...
describe('export', () => {
  ...
  describe('fromURL', () => {
    it('errors if no url defined', () => {
      return lib.fromURL(null, { yaml: true, concurrency }).catch((e) => {
    ...
    it('exports bootstrap stream', () => {
      ...
      return lib.fromURL('http://domain.com/_components/foo', { yaml: true, concurrency }).then((res) => {
        expect(res).toEqual([{
          _components: {
            foo: {
              a: 'b'
    ...
    it('exports dispatch from component instance', () => {
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      return lib.fromURL('http://domain.com/_components/foo', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all component instances', () => {
      ...
      return lib.fromURL('http://domain.com/_components/foo/instances', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all components', () => {
      ...
      return lib.fromURL('http://domain.com/_components', { concurrency }).then((res) => {
    ...
    it('exports dispatch from layout instance', () => {
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      return lib.fromURL('http://domain.com/_layouts/foo', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all layout instances', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      fetch.mockResponseOnce(JSON.stringify({ c: 'd' }));
      return lib.fromURL('http://domain.com/_layouts/foo/instances', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all layouts', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ e: 'f' })); // bar 1
      return lib.fromURL('http://domain.com/_layouts', { concurrency }).then((res) => {
    ...
    it('exports dispatch from page (legacy)', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      return lib.fromURL('http://domain.com/_pages/foo', { concurrency }).then((res) => {
        expect(res).toEqual([
    ...
    it('exports dispatch from page with layout (legacy)', () => {
      ...
      return lib.fromURL('http://domain.com/_pages/foo', { layout: true, concurrency }).then((res) => {
        expect(res).toEqual([
          { '/_components/foo/instances/1': { a: 'b' }},
    ...
    it('exports dispatch from all pages (legacy)', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' })); // foo child
      fetch.mockResponseOnce(JSON.stringify({
        layout: 'domain.com/_components/layout/instances/1',
        main: ['domain.com/_components/foo/instances/2']
      }));
      fetch.mockResponseOnce(JSON.stringify({ c: 'd' })); // bar child
      return lib.fromURL('http://domain.com/_pages', { concurrency }).then((res) => {
        expect(res).toEqual([
          { '/_components/foo/instances/1': { a: 'b' }},
          { '/_pages/foo': { layout: '/_components/layout/instances/1', main: ['/_components/foo/instances/1'] } },
    ...
    it('exports dispatch from all pages with shared layout (legacy)', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' })); // foo child
      fetch.mockResponseOnce(JSON.stringify({ main: 'main' })); // layout (first page includes it)
      fetch.mockResponseOnce(JSON.stringify({
        layout: 'domain.com/_components/layout/instances/1',
        main: ['domain.com/_components/foo/instances/2']
      }));
      fetch.mockResponseOnce(JSON.stringify({ c: 'd' })); // bar child
      return lib.fromURL('http://domain.com/_pages', { layout: true, concurrency }).then((res) => {
        expect(res).toEqual([
          { '/_components/foo/instances/1': { a: 'b' }},
    ...
    it('exports dispatch from uri', () => {
      ...
      return lib.fromURL('http://domain.com/_uris/ZG9tYWluLmNvbS9mb28=', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all uris', () => {
      ...
      return lib.fromURL('http://domain.com/_uris', { concurrency }).then((res) => {
    ...
    it('exports dispatch from list', () => {
      ...
      return lib.fromURL('http://domain.com/_lists/foo', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all lists', () => {
      ...
      return lib.fromURL('http://domain.com/_lists', { concurrency }).then((res) => {
    ...
    it('exports dispatch from user', () => {
      ...
      return lib.fromURL('http://domain.com/_users/YWxpY2VAZ29vZ2xl', { concurrency }).then((res) => {
    ...
    it('exports dispatch from all users', () => {
      ...
      return lib.fromURL('http://domain.com/_users', { concurrency }).then((res) => {
    ...
    it('exports dispatch from public url', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      return lib.fromURL('http://domain.com/some-slug', { concurrency }).then((res) => {
        expect(res).toEqual([
          { '/_components/foo/instances/1': { a: 'b' }},
          { '/_pages/foo': { layout: '/_components/layout/instances/1', main: ['/_components/foo/instances/1'] } }
        ]);
    ...
    it('returns error if not a supported type of data', () => {
      ...
      fetch.mockResponseOnce('', { status: 404 });
      return lib.fromURL('http://domain.com/_schedule/foo', { concurrency }).catch((e) => {
    ...
    it('uses default concurrency', () => {
      fetch.mockResponseOnce(JSON.stringify({ a: 'b' }));
      return lib.fromURL('http://domain.com/_components/foo').then((res) => {
        expect(res).toEqual([{ '/_components/foo': { a: 'b' }}]);
      });
    });
  });
  ...
  describe('fromQuery', () => {
    ...
    it('streams error if no url defined', () => {
      return lib.fromQuery(null, {}, { yaml: true, concurrency }).catch((e) => {
    ...
    it('streams error if no results found', () => {
      fetch.mockResponseOnce('', { status: 404 });
      return lib.fromQuery('http://domain.com', {}, { yaml: true, concurrency, key }).catch((e) => {
    ...
    it('exports bootstrap stream', () => {
      ...
      return lib.fromQuery('http://domain.com', {}, { yaml: true, concurrency, key }).then((res) => {
        expect(res).toEqual([{
          _components: {
            foo: {
              a: 'b',
    ...
    it('exports dispatch from components', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b', c: 'd' }));
      return lib.fromQuery('http://domain.com', {}, { concurrency, key }).then((res) => {
    ...
    it('exports dispatch with size', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b', c: 'd' }));
      return lib.fromQuery('http://domain.com', {}, { concurrency, key, size: 1 }).then((res) => {
        expect(res).toEqual([{ '/_components/foo': { a: 'b', c: 'd' }}]);
      });
    });
    ...
    it('uses default concurrency', () => {
      ...
      fetch.mockResponseOnce(JSON.stringify({ a: 'b', c: 'd' }));
      return lib.fromQuery('http://domain.com', null, { key }).then((res) => {
        expect(res).toEqual([{ '/_components/foo': { a: 'b', c: 'd' }}]);
      });
    });
  });
