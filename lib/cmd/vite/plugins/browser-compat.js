 ...
 *
 * browser-compat.bundle.test.js enforces rule 1 by bundling the libraries that
 * have broken before (safe-buffer, create-hash) and evaluating the output with
 * no global Buffer — a stub-shape regression fails CI, not an editor.
 *
 * ── node: prefix ────────────────────────────────────────────────────────────
 *
...
// HMAC is stringified in the browser. (Caught by browser-compat.bundle.test.js.)
//
