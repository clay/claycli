...
describe('import api', function () {
  ...
  describe('importUrl', function () {
    ...
    it ('overwrites components if opts.overwrite includes "components"', function () {
      mockReq('GET', aCmpt1UrlJson, {foo: 'bar'});
      mockReq('PUT', bCmpt1Url, 200);
    ...
    it ('throws error if opts.overwrite is invalid value', function () {
      expect(() => fn(aCmpt1Url, bSite, {overwrite: 'foo'})).to.throw(Error);
    });

    it ('throws error if opts.overwrite is Array with invalid value', function () {
      expect(() => fn(aCmpt1Url, bSite, {overwrite: ['foo']})).to.throw(Error);
    });
