...
describe('import api', function () {
  ...
  describe('importUrl', function () {
    ...
    it ('does not overwrite pages, components by default', function () {
      mockReq('GET', aPage1, {main: [aCmpt1Uri]});
      mockReq('GET', aCmpt1UrlJson, {});
      mockReq('GET', bPage1, {});
    ...
    it ('does not overwrite users by default', function () {
      mockReq('GET', 'http://a.com/users/a', {a: 'b'});
      mockReq('GET', 'http://b.com/users/a', {b: 'c'});
      return fn('http://a.com/users/a', bSite)
        .collect()
        .toPromise(Promise)
        .then((results) => {
          assertItems(results, [
            {url: 'http://b.com/users/a', status: 'skipped'}
          ]);
        });
    });

    it ('does not overwrite layouts even if "components" is included in opts.overwrite', function () {
      mockReq('GET', aPage1, {layout: aCmpt1Uri});
      mockReq('GET', aCmpt1UrlJson, {});
      mockReq('GET', bPage1, {});
      mockReq('GET', bCmpt1Url, {foo: 'bar'});
      mockReq('PUT', bPage1, 200);
    ...
    it ('overwrites pages if opts.overwrite includes "pages"', function () {
    ...
    it ('overwrites page-level components if opts.overwrite includes "components"', function () {
      mockReq('GET', aCmpt1UrlJson, {foo: 'bar'});
      mockReq('PUT', bCmpt1Url, 200);
    ...
    it ('overwrites layouts when opts.overwrite includes "layouts"', function () {
      mockReq('GET', aPage1, {layout: aCmpt1Uri});
      mockReq('GET', aCmpt1UrlJson, {foo: 'bar'});
      mockReq('GET', bPage1, {});
      mockReq('GET', bCmpt1Url, {});
    ...
    it ('overwrites lists if opts.overwrite includes "lists" (i.e. do not merge)', function () {
      mockReq('GET', 'http://a.com/lists/a', ['a', 'b', 'c']);
    ...
    it ('overwrites users if opts.overwrite includes "users"', function () {
      mockReq('GET', 'http://a.com/users/a', {a: 'b'});
      mockReq('GET', 'http://b.com/users/a', {c: 'd'});
      mockReq('PUT', 'http://b.com/users/a', 200);
      return fn('http://a.com/users/a', bSite, {overwrite: ['users']})
        .collect()
        .toPromise(Promise)
        .then(() => {
          assertReq('PUT', 'http://b.com/users/a', {a: 'b'});
    ...
    it ('throws error if opts.overwrite includes "all" with other resource types', function () {
      expect(() => fn(aCmpt1Url, bSite, {overwrite: ['all', 'components']})).to.throw(Error);
    });

    it ('throws error if opts.overwrite includes "none" with other resource types', function () {
      expect(() => fn(aCmpt1Url, bSite, {overwrite: ['none', 'components']})).to.throw(Error);
    });

    it ('throws error if opts.overwrite includes "layouts" without "components"', function () {
