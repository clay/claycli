const fn = require('./index').importPages,
  sinon = require('sinon'),
...
/**
* Configures stubbed clayInput.streamPageUris to resolve pages of the specified
* published state, e.g. fn(true, false, true) stubs it to return a published
* page, an unpublished page, and a published page.
*/
function mockPagesIndex(...pagePublishStates) {
  ...
  clayInput.streamPageUris.withArgs(aSite).returns(h(results));
}
