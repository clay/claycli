module.exports = {
  ...
  sourceKey: {
    alias: 'sourceKey',
    describe: 'api key of the source site',
    type: 'string',
    requiresArg: true
  },
  dryRun: {
  ...
  list: {
    alias: 'list',
    describe: 'specific list uri',
    type: 'string'
  },
  user: {
    alias: 'list',
    describe: 'specific user uri',
    type: 'string'
  },
  component: {
  ...
  overwrite: {
    demand: false,
    describe: 'Lists of asset types to overwrite. Types include "components", "lists", "layouts", and "pages".',
    type: 'array',
    default: []
  }
};
