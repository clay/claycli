...
describe('output files', () => {
  ...
  describe('saveBootstrap', () => {
    ...
    it('generates bootstrap data with component default data', (done) => {
      fn(jsonFile)([{ '/_components/foo': data }]).collect().toCallback((err) => {
    ...
    it('generates bootstrap data with component instance data', (done) => {
      fn(jsonFile)([{ '/_components/foo/instances/bar': data }]).collect().toCallback((err) => {
    ...
    it('generates bootstrap data with component default and instance data', (done) => {
      fn(jsonFile)([{ '/_components/foo': data }, { '/_components/foo/instances/bar': data }]).collect().toCallback((err) => {
    ...
    it('generates bootstrap data with component default and instance data, in any order', (done) => {
      fn(jsonFile)([{ '/_components/foo/instances/bar': data }, { '/_components/foo': data }]).collect().toCallback((err) => {
        expect(fs.outputJson).to.have.been.calledWith(jsonFile, { components: { foo: { a: 'b', instances: { bar: data }} }});
        done(err);
      });
    });
    ...
    it('deduplicates chunks', (done) => {
      fn(jsonFile)([{ '/_components/foo': data }, { '/_components/foo': { c: 'd' }}]).collect().toCallback((err) => {
    ...
    it('writes to yml if no ext', (done) => {
      fn(filePath)([{ '/_components/foo': data }]).collect().toCallback((err) => {
    ...
    it('writes to yml', (done) => {
      fn(ymlFile)([{ '/_components/foo': data }]).collect().toCallback((err) => {
        expect(fs.outputFile).to.have.been.calledWith(ymlFile);
        done(err);
      });
    });
    ...
    it('writes to yaml', (done) => {
      fn(yamlFile)([{ '/_components/foo': data }]).collect().toCallback((err) => {
    ...
    it('returns success objects when writing json', (done) => {
      fn(jsonFile)([{ '/_components/foo': data }]).collect().toCallback((err, res) => {
    ...
    it('returns success objects when writing yml', (done) => {
      fn(ymlFile)([{ '/_components/foo': data }]).collect().toCallback((err, res) => {
