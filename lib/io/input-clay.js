...
/**
 * Given a stream of urls, return a stream of {url, data} objects
 * representing Clay assets associated with each URL.
 * @param  {number} concurrency
 * @return {Stream} of objects with { url, data: stringified json }
 */
function streamAssets(concurrency) {
  return s => s
...
* resources, including the page itself. Page cmpts will not have "data"
* initially; use composeItem to fill.
* @param {string} url
* @param {number} concurrency
* @return {Stream}
**/
