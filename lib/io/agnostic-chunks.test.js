...
describe('agnostic chunks', () => {
  ...
  describe('parseObject', () => {
    ...
    it('parses uris', (done) => {
      fn({ _uris: { '/archive': '/_pages/archive' }}).collect().toCallback((err, data) => {
    ...
    it('parses lists', (done) => {
      fn({ _lists: { a: ['b', 'c'] }}).collect().toCallback((err, data) => {
    ...
    it('parses users', (done) => {
      fn({ _users: [{ username: 'foo', provider: 'bar' }]}).collect().toCallback((err, data) => {
    ...
    it('parses empty component defaults', (done) => {
      fn({ _components: { foo: {} }}).collect().toCallback((err, data) => {
        expect(data).to.eql([]);
        done(err);
      });
    });
    ...
    it('parses component defaults', (done) => {
      fn({ _components: { foo: { a: 'b' } }}).collect().toCallback((err, data) => {
