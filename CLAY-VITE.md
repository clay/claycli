...
| CSS compilation | [`lib/cmd/build/styles.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/styles.js) | Shared with `clay build` |
| Template compilation | [`lib/cmd/build/templates.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/templates.js) | Shared with `clay build` |
| Font processing | [`lib/cmd/build/fonts.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/fonts.js) | Shared with `clay build` |
| Media copy | [`lib/cmd/build/media.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/media.js) | Shared with `clay build` |
| Manifest writer | [`lib/cmd/build/manifest.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/manifest.js) | Writes `_manifest.json` |
| Script dependency resolver | [`lib/cmd/build/get-script-dependencies.js`](https://github.com/clay/claycli/blob/jordan/yolo-update/lib/cmd/build/get-script-dependencies.js) | `resolveModuleScripts`, `hasManifest` |
...
|---|---|---|
| `public/js/_manifest.json` | `lib/cmd/build/manifest.js` | Entry → file + chunks map. Replaces `_registry.json` + `_ids.json`. |
